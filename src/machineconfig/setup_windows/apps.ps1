...
winget install --no-upgrade --name "MiKTeX"                             --Id "MiKTeX.MiKTeX"                          --source winget --scope user --accept-package-agreements --accept-source-agreements
winget install --no-upgrade --name "TexMaker"                           --Id "Texmaker.Texmaker"                      --source winget --scope user --accept-package-agreements --accept-source-agreements
