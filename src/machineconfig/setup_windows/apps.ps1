...
#winget install --no-upgrade --name "perl" -e --id "StrawberryPerl.StrawberryPerl"  --source winget --scope user --accept-package-agreements --accept-source-agreements
...
winget install --no-upgrade --name "GnuPG" GnuPG.GnuPG --scope user --accept-package-agreements --accept-source-agreements
