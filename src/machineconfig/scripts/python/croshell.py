...
"""
    ...
    if visidata:
        ...
        else: requirements = f"""{uv_python_line} {user_uv_with_line} {uv_project_line} --with "marimo,sqlglot,cowsay,machineconfig[plot]>=8.23" """
        fire_line = f"""
...
"""
        ...
        else: requirements = f"""{user_uv_with_line} {uv_project_line} --with "cowsay,machineconfig[plot]>=8.23" """
...
uv venv
uv add "cowsay,machineconfig[plot]>=8.23"
uv add {user_uv_add}
# code serve-web
...
"""
        ...
        else: ve_line = f"""{uv_python_line} {user_uv_with_line} {uv_project_line} --with "cowsay,machineconfig[plot]>=8.23" """
