...
"""
    ...
    if visidata:
        ...
        else: requirements = f"""--python 3.14 {user_uv_with_line} user_uv_with_line--with "marimo,cowsay,machineconfig[plot]>=7.90" """
        fire_line = f"""
...
"""
        ...
        else: requirements = f"""{user_uv_with_line} --with "cowsay,machineconfig[plot]>=7.90" """
...
uv init --python 3.14
uv venv
uv add "cowsay,machineconfig[plot]>=7.90"
uv add {user_uv_add}
# code serve-web
...
"""
        ...
        else: ve_line = f"""--python 3.14 {user_uv_with_line} --with "cowsay,machineconfig[plot]>=7.90" """
