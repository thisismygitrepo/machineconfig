...
"""
    ...
    if visidata:
        ...
        else: requirements = """--python 3.14 --with "marimo,machineconfig[plot]>=7.50" """
        fire_line = f"""
...
"""
        ...
        else: requirements = """--with "machineconfig[plot]>=7.50" """
...
uv init --python 3.14
uv venv
uv add "machineconfig[plot]>=7.50"
# code serve-web
...
"""
        ...
        else: ve_line = """--python 3.14 --with "machineconfig[plot]>=7.50" """
