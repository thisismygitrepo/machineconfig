...
"""
    ...
    if visidata:
        ...
        else: requirements = """--python 3.14 --with "marimo,cowsay,machineconfig[plot]>=7.52" """
        fire_line = f"""
...
"""
        ...
        else: requirements = """--with "cowsay,machineconfig[plot]>=7.52" """
...
uv init --python 3.14
uv venv
uv add "cowsay,machineconfig[plot]>=7.52"
# code serve-web
...
"""
        ...
        else: ve_line = """--python 3.14 --with "cowsay,machineconfig[plot]>=7.52" """
