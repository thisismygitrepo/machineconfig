...
"""
    ...
    if visidata:
        ...
        else: requirements = f"""{uv_python_line} {user_uv_with_line} {uv_project_line} --with "marimo,cowsay,machineconfig[plot]>=7.99" """
        fire_line = f"""
...
"""
        ...
        else: requirements = f"""{user_uv_with_line} {uv_project_line} --with "cowsay,machineconfig[plot]>=7.99" """
...
uv venv
uv add "cowsay,machineconfig[plot]>=7.99"
uv add {user_uv_add}
# code serve-web
...
"""
        ...
        else: ve_line = f"""{uv_python_line} {user_uv_with_line} {uv_project_line} --with "cowsay,machineconfig[plot]>=7.99" """
