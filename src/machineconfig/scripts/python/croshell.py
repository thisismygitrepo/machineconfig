...
"""
    ...
    if visidata:
        ...
        else: requirements = """--python 3.14 --with "marimo,cowsay,machineconfig[plot]>=7.63" """
        fire_line = f"""
...
"""
        ...
        else: requirements = """--with "cowsay,machineconfig[plot]>=7.63" """
...
uv init --python 3.14
uv venv
uv add "cowsay,machineconfig[plot]>=7.63"
# code serve-web
...
"""
        ...
        else: ve_line = """--python 3.14 --with "cowsay,machineconfig[plot]>=7.63" """
