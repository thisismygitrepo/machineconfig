...
def main():
    ...
    new_theme = display_options(msg=f"Choose a theme number from the list above: ", options=list(themes) + ["random"], default="random")
    if new_theme == "random": new_theme = themes.sample()[0]
