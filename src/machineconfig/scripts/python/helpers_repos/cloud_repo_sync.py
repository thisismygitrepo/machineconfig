...
"""
    ...
    if res.is_successful(strict_err=True, strict_returcode=True):
        ...
        shell_file_1 = get_shell_file_executing_python_script(python_script=program_1_py, ve_path=None, executable="""uv run --with "machineconfig>=6.34" """)
        # ================================================================================
...
"""
        ...
        shell_file_3 = get_shell_file_executing_python_script(python_script=program_3_py, ve_path=None, executable="""uv run --with "machineconfig>=6.34" """)
        # ================================================================================
