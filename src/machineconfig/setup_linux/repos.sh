...
echo """
⏳ Cloning crocodile repository...
"""
git clone https://github.com/thisismygitrepo/crocodile.git --depth 4

echo """
⏳ Cloning machineconfig repository...
"""
...
echo """
📦 Installing crocodile package in development mode...
"""
cd $HOME/code/crocodile
if [ -n "$CROCODILE_EXRA" ]; then
  echo """
  ➕ Installing with extra dependencies: $CROCODILE_EXRA
  """
  $HOME/.local/bin/uv pip install -e .[$CROCODILE_EXRA]
else
  echo """
  🔄 Installing with standard dependencies
  """
...
echo """
📦 Installing machineconfig package in development mode...
"""
