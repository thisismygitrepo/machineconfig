...
def created_zellij_layout(tab_config: Dict[str, tuple[str, str]], output_dir: Optional[str] = None, default_cwd: Optional[str] = None) -> str:
...
if __name__ == "__main__":
    ...
    try:
        ...
        bot1_status = generator.check_command_status("🤖Bot1")
