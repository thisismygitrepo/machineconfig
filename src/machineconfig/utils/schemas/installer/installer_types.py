...
APP_INSTALLER_CATEGORY: TypeAlias = Literal["GITHUB_STANDARD", "CUSTOM_STANDARD", "GITHUB_DEV", "CUSTOM_DEV"]
...
class InstallerData(TypedDict):
    ...
    doc: str
    repoURL: str
    fileNamePattern: dict[CPU_ARCHITECTURES, dict[OPERATING_SYSTEMS, str]]
