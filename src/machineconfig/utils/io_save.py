...
PathLike = Union[str, P]


def _ensure_parent(path: PathLike) -> P:
    path_obj = P(path)
    path_obj.parent.mkdir(parents=True, exist_ok=True)
    return path_obj


def save_pickle(obj: Any, path: PathLike, verbose: bool = False) -> P:
...
def save_json(obj: Any, path: PathLike, indent: Optional[int] = None, verbose: bool = False) -> P:
    path_obj = _ensure_parent(path)
...
def save_toml(obj: Mapping[str, Any], path: PathLike, verbose: bool = False) -> P:
    if toml is None:
...
def save_yaml(obj: Any, path: PathLike, verbose: bool = False) -> P:
    if yaml is None:
...
def save_ini(path: PathLike, obj: Mapping[str, Mapping[str, Any]], verbose: bool = False) -> P:
...
class Save:
    ...
    @staticmethod
    def pickle(obj: Any, path: PathLike, verbose: bool = False, **_kwargs: Any) -> P:
        return save_pickle(obj=obj, path=path, verbose=verbose)

    @staticmethod
    def json(obj: Any, path: PathLike, indent: Optional[int] = None, verbose: bool = False, **_kwargs: Any) -> P:
        return save_json(obj=obj, path=path, indent=indent, verbose=verbose)

    @staticmethod
    def toml(obj: Mapping[str, Any], path: PathLike, verbose: bool = False, **_kwargs: Any) -> P:
        return save_toml(obj=obj, path=path, verbose=verbose)

    @staticmethod
    def yaml(obj: Any, path: PathLike, verbose: bool = False, **_kwargs: Any) -> P:
        return save_yaml(obj=obj, path=path, verbose=verbose)

    @staticmethod
    def ini(obj: Mapping[str, Mapping[str, Any]], path: PathLike, verbose: bool = False, **_kwargs: Any) -> P:
