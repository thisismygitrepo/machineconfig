...
def main(version: Optional[str] = None) -> None:
    if platform.system() == "Windows":
        ...
        get_latest_release(repo_url=repo_url, exe_name="navi", suffix="x86_64-unknown-linux-musl", download_n_extract=True, linux=True, compression="tar.gz", version=version)
    else:
