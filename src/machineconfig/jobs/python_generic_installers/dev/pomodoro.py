...
def main(version: Optional[str] = None) -> None:
    if platform.system() == "Windows":
        ...
        get_latest_release(repo_url=repo_url, suffix="linux_amd64", download_n_extract=True, linux=True, compression="tar.gz", version=version, strip_v=True, sep="_", exe_name="pomodoro")
    else:
