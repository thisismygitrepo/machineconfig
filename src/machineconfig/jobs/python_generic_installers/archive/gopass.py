...
def main(version: Optional[str] = None) -> None:
    ...
    elif system() == "Linux": get_latest_release(url, exe_name="gopass", suffix="linux-amd64", download_n_extract=True, linux=True, compression="tar.gz", strip_v=True, tool_name="gopass", delete=False, version=version)
