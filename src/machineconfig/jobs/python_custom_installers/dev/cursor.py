...
config_dict: InstallerData = {"appName": "Cursor", "repoURL": "CUSTOM", "doc": "Cursor", "filenameTemplate": {"amd64": {"windows": "VSCodeSetup-{version}.exe", "linux": "code_{version}.deb", "macos": ""}},  "exeName": "cursor"}
